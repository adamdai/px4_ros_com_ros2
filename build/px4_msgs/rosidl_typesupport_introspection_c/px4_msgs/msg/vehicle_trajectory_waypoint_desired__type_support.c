...
#include <stddef.h>
#include "px4_msgs/msg/vehicle_trajectory_waypoint_desired__rosidl_typesupport_introspection_c.h"
...
// Member `waypoints`
#include "px4_msgs/msg/trajectory_waypoint__rosidl_typesupport_introspection_c.h"
