...
#include "px4_msgs/msg/vehicle_local_position_setpoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, VehicleLocalPositionSetpoint)();
}
