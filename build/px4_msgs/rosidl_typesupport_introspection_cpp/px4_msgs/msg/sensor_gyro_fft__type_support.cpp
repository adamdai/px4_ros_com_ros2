...
size_t size_function__SensorGyroFft__peak_magnitude_x(const void * untyped_member)
{
  (void)untyped_member;
  return 6;
}

const void * get_const_function__SensorGyroFft__peak_magnitude_x(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__SensorGyroFft__peak_magnitude_x(void * untyped_member, size_t index)
{
  auto & member =
...
size_t size_function__SensorGyroFft__peak_magnitude_y(const void * untyped_member)
{
  (void)untyped_member;
  return 6;
}

const void * get_const_function__SensorGyroFft__peak_magnitude_y(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::array<uint32_t, 6> *>(untyped_member);
  return &member[index];
...
void * get_function__SensorGyroFft__peak_magnitude_y(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::array<uint32_t, 6> *>(untyped_member);
  return &member[index];
...
size_t size_function__SensorGyroFft__peak_magnitude_z(const void * untyped_member)
{
  (void)untyped_member;
  return 6;
}

const void * get_const_function__SensorGyroFft__peak_magnitude_z(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::array<uint32_t, 6> *>(untyped_member);
  return &member[index];
...
void * get_function__SensorGyroFft__peak_magnitude_z(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::array<uint32_t, 6> *>(untyped_member);
  return &member[index];
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorGyroFft_message_member_array[11] = {
  ...
  },
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::SensorGyroFft, peak_magnitude_x),  // bytes offset in struct
    nullptr,  // default value
    size_function__SensorGyroFft__peak_magnitude_x,  // size() function pointer
    get_const_function__SensorGyroFft__peak_magnitude_x,  // get_const(index) function pointer
    get_function__SensorGyroFft__peak_magnitude_x,  // get(index) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "peak_magnitude_y",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_UINT32,  // type
    0,  // upper bound of string
    nullptr,  // members of sub message
    true,  // is array
    6,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::SensorGyroFft, peak_magnitude_y),  // bytes offset in struct
    nullptr,  // default value
    size_function__SensorGyroFft__peak_magnitude_y,  // size() function pointer
    get_const_function__SensorGyroFft__peak_magnitude_y,  // get_const(index) function pointer
    get_function__SensorGyroFft__peak_magnitude_y,  // get(index) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "peak_magnitude_z",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_UINT32,  // type
    0,  // upper bound of string
    nullptr,  // members of sub message
    true,  // is array
    6,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::SensorGyroFft, peak_magnitude_z),  // bytes offset in struct
    nullptr,  // default value
    size_function__SensorGyroFft__peak_magnitude_z,  // size() function pointer
    get_const_function__SensorGyroFft__peak_magnitude_z,  // get_const(index) function pointer
    get_function__SensorGyroFft__peak_magnitude_z,  // get(index) function pointer
    nullptr  // resize(index) function pointer
  }
};
