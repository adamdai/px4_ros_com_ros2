...
#include "px4_msgs/msg/sensor_gyro_fft__rosidl_typesupport_fastrtps_c.h"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: peak_magnitude_x
  {
    size_t size = 6;
    auto array_ptr = ros_message->peak_magnitude_x;
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: peak_magnitude_y
  {
    size_t size = 6;
    auto array_ptr = ros_message->peak_magnitude_y;
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: peak_magnitude_z
  {
    size_t size = 6;
    auto array_ptr = ros_message->peak_magnitude_z;
    cdr.serializeArray(array_ptr, size);
  }
