...
#ifndef PX4_MSGS__MSG__TRANSPONDER_REPORT__STRUCT_HPP_
#define PX4_MSGS__MSG__TRANSPONDER_REPORT__STRUCT_HPP_
...
struct TransponderReport_
{
  ...
  explicit TransponderReport_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TransponderReport_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : callsign(_alloc),
    uas_id(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // PX4_MSGS__MSG__TRANSPONDER_REPORT__STRUCT_HPP_
