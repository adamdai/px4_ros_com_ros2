...
#ifndef PX4_MSGS__MSG__POSITION_SETPOINT_TRIPLET__STRUCT_HPP_
#define PX4_MSGS__MSG__POSITION_SETPOINT_TRIPLET__STRUCT_HPP_
...
struct PositionSetpointTriplet_
{
  ...
  explicit PositionSetpointTriplet_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : previous(_init),
    current(_init),
    next(_init)
  {
  ...
  explicit PositionSetpointTriplet_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__POSITION_SETPOINT_TRIPLET__STRUCT_HPP_
