...
#ifndef PX4_MSGS__MSG__YAW_ESTIMATOR_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__YAW_ESTIMATOR_STATUS__STRUCT_HPP_
...
struct YawEstimatorStatus_
{
  ...
  explicit YawEstimatorStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit YawEstimatorStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : yaw(_alloc),
    innov_vn(_alloc),
    innov_ve(_alloc),
    weight(_alloc)
...
#endif  // PX4_MSGS__MSG__YAW_ESTIMATOR_STATUS__STRUCT_HPP_
