...
#ifndef PX4_MSGS__MSG__ESC_STATUS__STRUCT_HPP_
...
// Member 'esc'
#include "px4_msgs/msg/esc_report__struct.hpp"
...
struct EscStatus_
{
  ...
  explicit EscStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EscStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : esc(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__ESC_STATUS__STRUCT_HPP_
