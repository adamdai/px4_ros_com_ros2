...
#ifndef PX4_MSGS__MSG__SATELLITE_INFO__STRUCT_HPP_
#define PX4_MSGS__MSG__SATELLITE_INFO__STRUCT_HPP_
...
struct SatelliteInfo_
{
  ...
  explicit SatelliteInfo_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SatelliteInfo_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : svid(_alloc),
    used(_alloc),
    elevation(_alloc),
    azimuth(_alloc),
...
#endif  // PX4_MSGS__MSG__SATELLITE_INFO__STRUCT_HPP_
