...
#ifndef PX4_MSGS__MSG__GIMBAL_DEVICE_INFORMATION__STRUCT_HPP_
#define PX4_MSGS__MSG__GIMBAL_DEVICE_INFORMATION__STRUCT_HPP_
...
struct GimbalDeviceInformation_
{
  ...
  explicit GimbalDeviceInformation_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GimbalDeviceInformation_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : vendor_name(_alloc),
    model_name(_alloc),
    custom_name(_alloc)
  {
...
#endif  // PX4_MSGS__MSG__GIMBAL_DEVICE_INFORMATION__STRUCT_HPP_
