...
#ifndef PX4_MSGS__MSG__LANDING_TARGET_POSE__STRUCT_HPP_
#define PX4_MSGS__MSG__LANDING_TARGET_POSE__STRUCT_HPP_
...
struct LandingTargetPose_
{
  ...
  explicit LandingTargetPose_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit LandingTargetPose_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__LANDING_TARGET_POSE__STRUCT_HPP_
