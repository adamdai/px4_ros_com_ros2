...
#ifndef PX4_MSGS__MSG__SENSOR_COMBINED__STRUCT_HPP_
#define PX4_MSGS__MSG__SENSOR_COMBINED__STRUCT_HPP_
...
struct SensorCombined_
{
  ...
  explicit SensorCombined_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SensorCombined_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : gyro_rad(_alloc),
...
#endif  // PX4_MSGS__MSG__SENSOR_COMBINED__STRUCT_HPP_
