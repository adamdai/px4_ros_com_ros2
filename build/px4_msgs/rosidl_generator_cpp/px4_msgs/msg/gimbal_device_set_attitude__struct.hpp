...
#ifndef PX4_MSGS__MSG__GIMBAL_DEVICE_SET_ATTITUDE__STRUCT_HPP_
#define PX4_MSGS__MSG__GIMBAL_DEVICE_SET_ATTITUDE__STRUCT_HPP_
...
struct GimbalDeviceSetAttitude_
{
  ...
  explicit GimbalDeviceSetAttitude_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GimbalDeviceSetAttitude_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : q(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__GIMBAL_DEVICE_SET_ATTITUDE__STRUCT_HPP_
