...
#ifndef PX4_MSGS__MSG__VEHICLE_ACTUATOR_SETPOINT__STRUCT_HPP_
...
struct VehicleActuatorSetpoint_
{
  ...
  explicit VehicleActuatorSetpoint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleActuatorSetpoint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : actuator(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__VEHICLE_ACTUATOR_SETPOINT__STRUCT_HPP_
