...
#ifndef PX4_MSGS__MSG__COLLISION_CONSTRAINTS__STRUCT_HPP_
#define PX4_MSGS__MSG__COLLISION_CONSTRAINTS__STRUCT_HPP_
...
struct CollisionConstraints_
{
  ...
  explicit CollisionConstraints_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit CollisionConstraints_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__COLLISION_CONSTRAINTS__STRUCT_HPP_
