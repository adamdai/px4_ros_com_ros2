...
#ifndef PX4_MSGS__MSG__VEHICLE_TRAJECTORY_BEZIER__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_TRAJECTORY_BEZIER__STRUCT_HPP_
...
struct VehicleTrajectoryBezier_
{
  ...
  explicit VehicleTrajectoryBezier_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleTrajectoryBezier_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__VEHICLE_TRAJECTORY_BEZIER__STRUCT_HPP_
