...
#ifndef PX4_MSGS__MSG__VEHICLE_ATTITUDE__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_ATTITUDE__STRUCT_HPP_
...
struct VehicleAttitude_
{
  ...
  explicit VehicleAttitude_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleAttitude_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : q(_alloc),
...
#endif  // PX4_MSGS__MSG__VEHICLE_ATTITUDE__STRUCT_HPP_
