...
#ifndef PX4_MSGS__MSG__SENSOR_CORRECTION__STRUCT_HPP_
#define PX4_MSGS__MSG__SENSOR_CORRECTION__STRUCT_HPP_
...
struct SensorCorrection_
{
  ...
  explicit SensorCorrection_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SensorCorrection_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__SENSOR_CORRECTION__STRUCT_HPP_
