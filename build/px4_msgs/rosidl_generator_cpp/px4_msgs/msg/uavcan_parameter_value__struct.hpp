...
#ifndef PX4_MSGS__MSG__UAVCAN_PARAMETER_VALUE__STRUCT_HPP_
#define PX4_MSGS__MSG__UAVCAN_PARAMETER_VALUE__STRUCT_HPP_
...
struct UavcanParameterValue_
{
  ...
  explicit UavcanParameterValue_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit UavcanParameterValue_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : param_id(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__UAVCAN_PARAMETER_VALUE__STRUCT_HPP_
