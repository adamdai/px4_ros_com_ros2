...
#ifndef PX4_MSGS__MSG__TASK_STACK_INFO__STRUCT_HPP_
#define PX4_MSGS__MSG__TASK_STACK_INFO__STRUCT_HPP_
...
struct TaskStackInfo_
{
  ...
  explicit TaskStackInfo_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TaskStackInfo_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : task_name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__TASK_STACK_INFO__STRUCT_HPP_
