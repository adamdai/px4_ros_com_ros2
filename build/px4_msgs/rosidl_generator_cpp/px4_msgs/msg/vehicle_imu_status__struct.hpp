...
#ifndef PX4_MSGS__MSG__VEHICLE_IMU_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_IMU_STATUS__STRUCT_HPP_
...
struct VehicleImuStatus_
{
  ...
  explicit VehicleImuStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleImuStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__VEHICLE_IMU_STATUS__STRUCT_HPP_
