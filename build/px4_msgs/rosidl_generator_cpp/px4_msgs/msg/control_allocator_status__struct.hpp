...
#ifndef PX4_MSGS__MSG__CONTROL_ALLOCATOR_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__CONTROL_ALLOCATOR_STATUS__STRUCT_HPP_
...
struct ControlAllocatorStatus_
{
  ...
  explicit ControlAllocatorStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ControlAllocatorStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__CONTROL_ALLOCATOR_STATUS__STRUCT_HPP_
