...
#ifndef PX4_MSGS__MSG__RC_PARAMETER_MAP__STRUCT_HPP_
#define PX4_MSGS__MSG__RC_PARAMETER_MAP__STRUCT_HPP_
...
struct RcParameterMap_
{
  ...
  explicit RcParameterMap_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit RcParameterMap_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : valid(_alloc),
    param_index(_alloc),
    param_id(_alloc),
    scale(_alloc),
...
#endif  // PX4_MSGS__MSG__RC_PARAMETER_MAP__STRUCT_HPP_
