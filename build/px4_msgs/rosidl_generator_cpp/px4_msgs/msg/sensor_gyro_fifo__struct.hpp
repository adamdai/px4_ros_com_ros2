...
#ifndef PX4_MSGS__MSG__SENSOR_GYRO_FIFO__STRUCT_HPP_
#define PX4_MSGS__MSG__SENSOR_GYRO_FIFO__STRUCT_HPP_
...
struct SensorGyroFifo_
{
  ...
  explicit SensorGyroFifo_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SensorGyroFifo_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : x(_alloc),
    y(_alloc),
    z(_alloc)
  {
...
#endif  // PX4_MSGS__MSG__SENSOR_GYRO_FIFO__STRUCT_HPP_
