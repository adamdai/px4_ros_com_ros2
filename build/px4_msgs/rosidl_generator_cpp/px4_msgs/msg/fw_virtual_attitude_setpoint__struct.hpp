...
#ifndef PX4_MSGS__MSG__FW_VIRTUAL_ATTITUDE_SETPOINT__STRUCT_HPP_
#define PX4_MSGS__MSG__FW_VIRTUAL_ATTITUDE_SETPOINT__STRUCT_HPP_
...
struct FwVirtualAttitudeSetpoint_
{
  ...
  explicit FwVirtualAttitudeSetpoint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit FwVirtualAttitudeSetpoint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : q_d(_alloc),
    thrust_body(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // PX4_MSGS__MSG__FW_VIRTUAL_ATTITUDE_SETPOINT__STRUCT_HPP_
