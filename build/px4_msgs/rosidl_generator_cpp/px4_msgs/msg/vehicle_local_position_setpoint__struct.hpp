...
#ifndef PX4_MSGS__MSG__VEHICLE_LOCAL_POSITION_SETPOINT__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_LOCAL_POSITION_SETPOINT__STRUCT_HPP_
...
struct VehicleLocalPositionSetpoint_
{
  ...
  explicit VehicleLocalPositionSetpoint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleLocalPositionSetpoint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : acceleration(_alloc),
    jerk(_alloc),
    thrust(_alloc)
  {
...
#endif  // PX4_MSGS__MSG__VEHICLE_LOCAL_POSITION_SETPOINT__STRUCT_HPP_
