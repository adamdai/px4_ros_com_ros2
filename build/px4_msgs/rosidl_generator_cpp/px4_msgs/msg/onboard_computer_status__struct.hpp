...
#ifndef PX4_MSGS__MSG__ONBOARD_COMPUTER_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__ONBOARD_COMPUTER_STATUS__STRUCT_HPP_
...
struct OnboardComputerStatus_
{
  ...
  explicit OnboardComputerStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit OnboardComputerStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : cpu_cores(_alloc),
    cpu_combined(_alloc),
    gpu_cores(_alloc),
    gpu_combined(_alloc),
...
#endif  // PX4_MSGS__MSG__ONBOARD_COMPUTER_STATUS__STRUCT_HPP_
