...
#ifndef PX4_MSGS__MSG__VEHICLE_MAGNETOMETER__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_MAGNETOMETER__STRUCT_HPP_
...
struct VehicleMagnetometer_
{
  ...
  explicit VehicleMagnetometer_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleMagnetometer_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__VEHICLE_MAGNETOMETER__STRUCT_HPP_
