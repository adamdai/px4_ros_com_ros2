...
#ifndef PX4_MSGS__MSG__DEBUG_ARRAY__STRUCT_HPP_
#define PX4_MSGS__MSG__DEBUG_ARRAY__STRUCT_HPP_
...
struct DebugArray_
{
  ...
  explicit DebugArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit DebugArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : name(_alloc),
    data(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // PX4_MSGS__MSG__DEBUG_ARRAY__STRUCT_HPP_
