...
#ifndef PX4_MSGS__MSG__ACTUATOR_CONTROLS__STRUCT_HPP_
#define PX4_MSGS__MSG__ACTUATOR_CONTROLS__STRUCT_HPP_
...
struct ActuatorControls_
{
  ...
  explicit ActuatorControls_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ActuatorControls_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : control(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__ACTUATOR_CONTROLS__STRUCT_HPP_
