...
#ifndef PX4_MSGS__MSG__DEBUG_KEY_VALUE__STRUCT_HPP_
#define PX4_MSGS__MSG__DEBUG_KEY_VALUE__STRUCT_HPP_
...
struct DebugKeyValue_
{
  ...
  explicit DebugKeyValue_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit DebugKeyValue_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : key(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__DEBUG_KEY_VALUE__STRUCT_HPP_
