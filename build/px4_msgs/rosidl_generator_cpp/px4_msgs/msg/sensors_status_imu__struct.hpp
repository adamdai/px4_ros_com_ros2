...
#ifndef PX4_MSGS__MSG__SENSORS_STATUS_IMU__STRUCT_HPP_
...
struct SensorsStatusImu_
{
  ...
  explicit SensorsStatusImu_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SensorsStatusImu_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__SENSORS_STATUS_IMU__STRUCT_HPP_
