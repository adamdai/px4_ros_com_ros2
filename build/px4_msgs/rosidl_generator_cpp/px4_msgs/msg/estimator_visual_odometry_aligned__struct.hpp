...
#ifndef PX4_MSGS__MSG__ESTIMATOR_VISUAL_ODOMETRY_ALIGNED__STRUCT_HPP_
...
struct EstimatorVisualOdometryAligned_
{
  ...
  explicit EstimatorVisualOdometryAligned_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorVisualOdometryAligned_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : q(_alloc),
    q_offset(_alloc),
...
#endif  // PX4_MSGS__MSG__ESTIMATOR_VISUAL_ODOMETRY_ALIGNED__STRUCT_HPP_
