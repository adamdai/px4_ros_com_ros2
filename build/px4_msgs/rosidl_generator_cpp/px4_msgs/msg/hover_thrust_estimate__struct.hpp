...
#ifndef PX4_MSGS__MSG__HOVER_THRUST_ESTIMATE__STRUCT_HPP_
#define PX4_MSGS__MSG__HOVER_THRUST_ESTIMATE__STRUCT_HPP_
...
struct HoverThrustEstimate_
{
  ...
  explicit HoverThrustEstimate_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit HoverThrustEstimate_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__HOVER_THRUST_ESTIMATE__STRUCT_HPP_
