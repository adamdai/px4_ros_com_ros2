...
#ifndef PX4_MSGS__MSG__OBSTACLE_DISTANCE__STRUCT_HPP_
#define PX4_MSGS__MSG__OBSTACLE_DISTANCE__STRUCT_HPP_
...
struct ObstacleDistance_
{
  ...
  explicit ObstacleDistance_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ObstacleDistance_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : distances(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__OBSTACLE_DISTANCE__STRUCT_HPP_
