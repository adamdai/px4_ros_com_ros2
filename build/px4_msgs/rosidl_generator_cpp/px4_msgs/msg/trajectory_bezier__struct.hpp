...
#ifndef PX4_MSGS__MSG__TRAJECTORY_BEZIER__STRUCT_HPP_
#define PX4_MSGS__MSG__TRAJECTORY_BEZIER__STRUCT_HPP_
...
struct TrajectoryBezier_
{
  ...
  explicit TrajectoryBezier_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TrajectoryBezier_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : position(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__TRAJECTORY_BEZIER__STRUCT_HPP_
