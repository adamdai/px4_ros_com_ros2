...
#ifndef PX4_MSGS__MSG__ACTUATOR_OUTPUTS__STRUCT_HPP_
#define PX4_MSGS__MSG__ACTUATOR_OUTPUTS__STRUCT_HPP_
...
struct ActuatorOutputs_
{
  ...
  explicit ActuatorOutputs_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ActuatorOutputs_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : output(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__ACTUATOR_OUTPUTS__STRUCT_HPP_
