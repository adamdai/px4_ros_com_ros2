...
#ifndef PX4_MSGS__MSG__ORB_TEST_MEDIUM__STRUCT_HPP_
#define PX4_MSGS__MSG__ORB_TEST_MEDIUM__STRUCT_HPP_
...
struct OrbTestMedium_
{
  ...
  explicit OrbTestMedium_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit OrbTestMedium_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : junk(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__ORB_TEST_MEDIUM__STRUCT_HPP_
