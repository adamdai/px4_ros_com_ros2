...
#ifndef PX4_MSGS__MSG__GIMBAL_MANAGER_SET_ATTITUDE__STRUCT_HPP_
#define PX4_MSGS__MSG__GIMBAL_MANAGER_SET_ATTITUDE__STRUCT_HPP_
...
struct GimbalManagerSetAttitude_
{
  ...
  explicit GimbalManagerSetAttitude_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GimbalManagerSetAttitude_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : q(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__GIMBAL_MANAGER_SET_ATTITUDE__STRUCT_HPP_
