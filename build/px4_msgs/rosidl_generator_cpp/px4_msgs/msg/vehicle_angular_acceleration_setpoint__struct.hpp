...
#ifndef PX4_MSGS__MSG__VEHICLE_ANGULAR_ACCELERATION_SETPOINT__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_ANGULAR_ACCELERATION_SETPOINT__STRUCT_HPP_
...
struct VehicleAngularAccelerationSetpoint_
{
  ...
  explicit VehicleAngularAccelerationSetpoint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleAngularAccelerationSetpoint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : xyz(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__VEHICLE_ANGULAR_ACCELERATION_SETPOINT__STRUCT_HPP_
