...
#ifndef PX4_MSGS__MSG__MANUAL_CONTROL_SWITCHES__STRUCT_HPP_
#define PX4_MSGS__MSG__MANUAL_CONTROL_SWITCHES__STRUCT_HPP_
...
struct ManualControlSwitches_
{
  ...
  explicit ManualControlSwitches_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ManualControlSwitches_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__MANUAL_CONTROL_SWITCHES__STRUCT_HPP_
