...
#ifndef PX4_MSGS__MSG__VEHICLE_TRAJECTORY_WAYPOINT__STRUCT_HPP_
...
struct VehicleTrajectoryWaypoint_
{
  ...
  explicit VehicleTrajectoryWaypoint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleTrajectoryWaypoint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : waypoints(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__VEHICLE_TRAJECTORY_WAYPOINT__STRUCT_HPP_
