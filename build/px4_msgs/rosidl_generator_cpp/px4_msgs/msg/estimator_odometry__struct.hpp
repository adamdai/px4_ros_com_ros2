...
#ifndef PX4_MSGS__MSG__ESTIMATOR_ODOMETRY__STRUCT_HPP_
#define PX4_MSGS__MSG__ESTIMATOR_ODOMETRY__STRUCT_HPP_
...
struct EstimatorOdometry_
{
  ...
  explicit EstimatorOdometry_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorOdometry_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : q(_alloc),
    q_offset(_alloc),
...
#endif  // PX4_MSGS__MSG__ESTIMATOR_ODOMETRY__STRUCT_HPP_
