...
#ifndef PX4_MSGS__MSG__SYSTEM_POWER__STRUCT_HPP_
#define PX4_MSGS__MSG__SYSTEM_POWER__STRUCT_HPP_
...
struct SystemPower_
{
  ...
  explicit SystemPower_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SystemPower_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : sensors3v3(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__SYSTEM_POWER__STRUCT_HPP_
