...
#ifndef PX4_MSGS__MSG__RC_CHANNELS__STRUCT_HPP_
#define PX4_MSGS__MSG__RC_CHANNELS__STRUCT_HPP_
...
struct RcChannels_
{
  ...
  explicit RcChannels_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit RcChannels_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : channels(_alloc),
    function(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // PX4_MSGS__MSG__RC_CHANNELS__STRUCT_HPP_
