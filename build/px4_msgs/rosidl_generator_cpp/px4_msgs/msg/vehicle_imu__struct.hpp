...
#ifndef PX4_MSGS__MSG__VEHICLE_IMU__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_IMU__STRUCT_HPP_
...
struct VehicleImu_
{
  ...
  explicit VehicleImu_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleImu_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : delta_angle(_alloc),
...
#endif  // PX4_MSGS__MSG__VEHICLE_IMU__STRUCT_HPP_
