...
#ifndef PX4_MSGS__MSG__QSHELL_REQ__STRUCT_HPP_
#define PX4_MSGS__MSG__QSHELL_REQ__STRUCT_HPP_
...
struct QshellReq_
{
  ...
  explicit QshellReq_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit QshellReq_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : cmd(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__QSHELL_REQ__STRUCT_HPP_
