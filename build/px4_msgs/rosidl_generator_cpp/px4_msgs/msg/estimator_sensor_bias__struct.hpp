...
#ifndef PX4_MSGS__MSG__ESTIMATOR_SENSOR_BIAS__STRUCT_HPP_
#define PX4_MSGS__MSG__ESTIMATOR_SENSOR_BIAS__STRUCT_HPP_
...
struct EstimatorSensorBias_
{
  ...
  explicit EstimatorSensorBias_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorSensorBias_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : gyro_bias(_alloc),
...
#endif  // PX4_MSGS__MSG__ESTIMATOR_SENSOR_BIAS__STRUCT_HPP_
