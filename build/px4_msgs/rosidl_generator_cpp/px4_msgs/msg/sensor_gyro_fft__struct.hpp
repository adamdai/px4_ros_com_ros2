...
#ifndef PX4_MSGS__MSG__SENSOR_GYRO_FFT__STRUCT_HPP_
#define PX4_MSGS__MSG__SENSOR_GYRO_FFT__STRUCT_HPP_
...
struct SensorGyroFft_
{
  ...
  explicit SensorGyroFft_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<uint32_t, 6>::iterator, uint32_t>(this->peak_magnitude_x.begin(), this->peak_magnitude_x.end(), 0ul);
      std::fill<typename std::array<uint32_t, 6>::iterator, uint32_t>(this->peak_magnitude_y.begin(), this->peak_magnitude_y.end(), 0ul);
      std::fill<typename std::array<uint32_t, 6>::iterator, uint32_t>(this->peak_magnitude_z.begin(), this->peak_magnitude_z.end(), 0ul);
    }
  }

  explicit SensorGyroFft_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : peak_frequencies_x(_alloc),
    peak_frequencies_y(_alloc),
    peak_frequencies_z(_alloc),
    peak_magnitude_x(_alloc),
    peak_magnitude_y(_alloc),
    peak_magnitude_z(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  using _peak_magnitude_x_type =
    std::array<uint32_t, 6>;
  _peak_magnitude_x_type peak_magnitude_x;
  using _peak_magnitude_y_type =
    std::array<uint32_t, 6>;
  _peak_magnitude_y_type peak_magnitude_y;
  using _peak_magnitude_z_type =
    std::array<uint32_t, 6>;
  _peak_magnitude_z_type peak_magnitude_z;
  ...
  Type & set__peak_magnitude_x(
    const std::array<uint32_t, 6> & _arg)
  {
    this->peak_magnitude_x = _arg;
    return *this;
  }
  Type & set__peak_magnitude_y(
    const std::array<uint32_t, 6> & _arg)
  {
    this->peak_magnitude_y = _arg;
    return *this;
  }
  Type & set__peak_magnitude_z(
    const std::array<uint32_t, 6> & _arg)
  {
    this->peak_magnitude_z = _arg;
    return *this;
  }
  ...
  bool operator==(const SensorGyroFft_ & other) const
  {
    ...
    if (this->peak_magnitude_x != other.peak_magnitude_x) {
      return false;
    }
    if (this->peak_magnitude_y != other.peak_magnitude_y) {
      return false;
    }
    if (this->peak_magnitude_z != other.peak_magnitude_z) {
      return false;
    }
    return true;
  }
...
#endif  // PX4_MSGS__MSG__SENSOR_GYRO_FFT__STRUCT_HPP_
