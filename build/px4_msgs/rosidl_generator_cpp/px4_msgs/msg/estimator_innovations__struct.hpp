...
#ifndef PX4_MSGS__MSG__ESTIMATOR_INNOVATIONS__STRUCT_HPP_
#define PX4_MSGS__MSG__ESTIMATOR_INNOVATIONS__STRUCT_HPP_
...
struct EstimatorInnovations_
{
  ...
  explicit EstimatorInnovations_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorInnovations_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : gps_hvel(_alloc),
    gps_hpos(_alloc),
    ev_hvel(_alloc),
    ev_hpos(_alloc),
...
#endif  // PX4_MSGS__MSG__ESTIMATOR_INNOVATIONS__STRUCT_HPP_
