...
#ifndef PX4_MSGS__MSG__VEHICLE_ANGULAR_VELOCITY__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_ANGULAR_VELOCITY__STRUCT_HPP_
...
struct VehicleAngularVelocity_
{
  ...
  explicit VehicleAngularVelocity_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleAngularVelocity_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : xyz(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__VEHICLE_ANGULAR_VELOCITY__STRUCT_HPP_
