...
#ifndef PX4_MSGS__MSG__ESTIMATOR_SELECTOR_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__ESTIMATOR_SELECTOR_STATUS__STRUCT_HPP_
...
struct EstimatorSelectorStatus_
{
  ...
  explicit EstimatorSelectorStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorSelectorStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__ESTIMATOR_SELECTOR_STATUS__STRUCT_HPP_
