...
#ifndef PX4_MSGS__MSG__EKF2_TIMESTAMPS__STRUCT_HPP_
#define PX4_MSGS__MSG__EKF2_TIMESTAMPS__STRUCT_HPP_
...
struct Ekf2Timestamps_
{
  ...
  explicit Ekf2Timestamps_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Ekf2Timestamps_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__EKF2_TIMESTAMPS__STRUCT_HPP_
