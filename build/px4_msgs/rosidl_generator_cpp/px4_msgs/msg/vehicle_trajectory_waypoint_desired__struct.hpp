...
#ifndef PX4_MSGS__MSG__VEHICLE_TRAJECTORY_WAYPOINT_DESIRED__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_TRAJECTORY_WAYPOINT_DESIRED__STRUCT_HPP_
...
// Member 'waypoints'
#include "px4_msgs/msg/trajectory_waypoint__struct.hpp"
...
struct VehicleTrajectoryWaypointDesired_
{
  ...
  explicit VehicleTrajectoryWaypointDesired_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleTrajectoryWaypointDesired_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : waypoints(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__VEHICLE_TRAJECTORY_WAYPOINT_DESIRED__STRUCT_HPP_
