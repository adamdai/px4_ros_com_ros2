...
#ifndef PX4_MSGS__MSG__UAVCAN_PARAMETER_REQUEST__STRUCT_HPP_
#define PX4_MSGS__MSG__UAVCAN_PARAMETER_REQUEST__STRUCT_HPP_
...
struct UavcanParameterRequest_
{
  ...
  explicit UavcanParameterRequest_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit UavcanParameterRequest_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : param_id(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__UAVCAN_PARAMETER_REQUEST__STRUCT_HPP_
