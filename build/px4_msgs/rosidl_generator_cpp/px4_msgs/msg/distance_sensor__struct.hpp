...
#ifndef PX4_MSGS__MSG__DISTANCE_SENSOR__STRUCT_HPP_
#define PX4_MSGS__MSG__DISTANCE_SENSOR__STRUCT_HPP_
...
struct DistanceSensor_
{
  ...
  explicit DistanceSensor_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit DistanceSensor_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : q(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__DISTANCE_SENSOR__STRUCT_HPP_
