...
#ifndef PX4_MSGS__MSG__ADC_REPORT__STRUCT_HPP_
#define PX4_MSGS__MSG__ADC_REPORT__STRUCT_HPP_
...
struct AdcReport_
{
  ...
  explicit AdcReport_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit AdcReport_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : channel_id(_alloc),
    raw_data(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // PX4_MSGS__MSG__ADC_REPORT__STRUCT_HPP_
