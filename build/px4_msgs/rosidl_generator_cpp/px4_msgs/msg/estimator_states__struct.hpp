...
#ifndef PX4_MSGS__MSG__ESTIMATOR_STATES__STRUCT_HPP_
#define PX4_MSGS__MSG__ESTIMATOR_STATES__STRUCT_HPP_
...
struct EstimatorStates_
{
  ...
  explicit EstimatorStates_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorStates_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : states(_alloc),
    covariances(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // PX4_MSGS__MSG__ESTIMATOR_STATES__STRUCT_HPP_
