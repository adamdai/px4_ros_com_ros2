...
#ifndef PX4_MSGS__MSG__TRAJECTORY_WAYPOINT__STRUCT_HPP_
#define PX4_MSGS__MSG__TRAJECTORY_WAYPOINT__STRUCT_HPP_
...
struct TrajectoryWaypoint_
{
  ...
  explicit TrajectoryWaypoint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TrajectoryWaypoint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : position(_alloc),
    velocity(_alloc),
    acceleration(_alloc)
  {
...
#endif  // PX4_MSGS__MSG__TRAJECTORY_WAYPOINT__STRUCT_HPP_
