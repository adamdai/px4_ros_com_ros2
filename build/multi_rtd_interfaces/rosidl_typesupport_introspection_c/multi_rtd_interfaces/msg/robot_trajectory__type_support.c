...
#include <stddef.h>
#include "multi_rtd_interfaces/msg/robot_trajectory__rosidl_typesupport_introspection_c.h"
#include "multi_rtd_interfaces/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c_message_initialization _init)
{
  ...
  (void) _init;
  multi_rtd_interfaces__msg__RobotTrajectory__init(message_memory);
}

void RobotTrajectory__rosidl_typesupport_introspection_c__RobotTrajectory_fini_function(void * message_memory)
{
  multi_rtd_interfaces__msg__RobotTrajectory__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RobotTrajectory__rosidl_typesupport_introspection_c__RobotTrajectory_message_member_array[2] = {
  {
    ...
    offsetof(multi_rtd_interfaces__msg__RobotTrajectory, robot_name),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(multi_rtd_interfaces__msg__RobotTrajectory, trajectory),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RobotTrajectory__rosidl_typesupport_introspection_c__RobotTrajectory_message_members = {
  "multi_rtd_interfaces__msg",  // message namespace
  "RobotTrajectory",  // message name
  2,  // number of fields
  sizeof(multi_rtd_interfaces__msg__RobotTrajectory),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_multi_rtd_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_rtd_interfaces, msg, RobotTrajectory)() {
