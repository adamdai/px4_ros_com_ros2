...
bool multi_rtd_interfaces__msg__robot_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "multi_rtd_interfaces.msg._robot_trajectory.RobotTrajectory",
        full_classname_dest, 58) == 0);
  }
  multi_rtd_interfaces__msg__RobotTrajectory * ros_message = _ros_message;
  {  // robot_name
    ...
    rosidl_generator_c__String__assign(&ros_message->robot_name, PyBytes_AS_STRING(encoded_field));
...
PyObject * multi_rtd_interfaces__msg__robot_trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("multi_rtd_interfaces.msg._robot_trajectory");
